package com.example.wineshoppinglist.other
...
class ShoppingItemAdapter (var items: List<WinesItem>, private val viewModel:ShoppingViewModel):RecyclerView.Adapter
